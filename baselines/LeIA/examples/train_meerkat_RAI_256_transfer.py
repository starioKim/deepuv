...
np.save("/share/gpu0/mars/TNG_data/meerkat_clean/pred/pred_train_GUNet_psf.npy", pred_train)
np.save("/share/gpu0/mars/TNG_data/meerkat_clean/pred/pred_test_GUNet_psf.npy", pred_test)
